describe("populate", function () {
    beforeEach(function () {
        ...
        item = {
            snippet: {
                ...
                title: "Romantic Hindi Love Songs 2020 💖 Latest Bollywood Songs 2020 💖 Bollywood New Song 2020 🔴 Live",
                thumbnails: {
                    high: {
    ...
    it("should add content to created thumbnails", function (done) {
        ...
        populate();
         ...
         expect(sampleDiv.querySelector('.title').textContent).toEqual("Romantic Hindi Love Songs 2020 💖 Latest Bollywood Songs 2020 💖 Bollywood New Song 2020 🔴 Live");
         expect(sampleDiv.querySelector('.publisher').textContent).toBe("Bollywood Hits Songs");
        done();
    });
});
